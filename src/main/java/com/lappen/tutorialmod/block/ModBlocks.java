package com.lappen.tutorialmod.block;

import com.lappen.tutorialmod.TemplateMod;
import com.lappen.tutorialmod.block.custom.MagicBlock;
...
public class ModBlocks {
    ...
    public static final Block PINK_GARNET_BLOCK = registerBlock("pink_garnet_block",
            new Block(AbstractBlock.Settings.create().strength(4f)
                    .requiresTool().burnable().replaceable().luminance(state -> 10).sounds(BlockSoundGroup.AMETHYST_BLOCK)));
